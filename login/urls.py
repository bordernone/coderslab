...
urlpatterns = [
    ...
    path('recover/', auth_views.PasswordResetView.as_view(template_name='accountrecover/recoveraccount.html', html_email_template_name='accountrecover/passwordresetemailtemplate.html', extra_context = {'fbappid': facebookAppId}) ,name="password_reset"),
